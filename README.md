...
2. Objectives define *what* you want to achieve
...
| Database | SQLModel (SQLite) for users/cycles |
| Storage | JSON files per user + optional Google Sheets sync |
...
*Built for excellence in strategic alignment and execution tracking.*
