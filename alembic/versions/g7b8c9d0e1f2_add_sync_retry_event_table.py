"""Add durable sync retry queue table.

Revision ID: g7b8c9d0e1f2
Revises: f6a7b8c9d0e1
Create Date: 2026-02-13 13:45:00.000000
"""
...
def upgrade() -> None:
    ...
    if "ix_sync_retry_event_queue_key" not in existing_indexes:
        op.create_index(
    ...
    if "ix_sync_retry_event_next_attempt" not in existing_indexes:
        op.create_index(
    ...
    if "ck_sync_retry_attempts_non_negative" not in _check_names("sync_retry_event"):
