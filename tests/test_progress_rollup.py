...
def test_rollup_calculation(isolated_db):
    from src.crud import create_user, create_goal, create_objective, create_key_result, create_check_in, update_key_result
    from src.database import get_session_context
    from src.models import Goal, Objective, KeyResult

    # Setup hierarchy
    owner = create_user("alice", "pass")
...
def test_weighted_rollup(isolated_db):
    from src.crud import create_user, create_goal, create_objective, create_key_result, create_check_in
    from src.database import get_session_context
    from src.models import Objective, KeyResult

    owner = create_user("bob", "pass")
