...
| C4 - Lint gate and `spa-bff` typecheck | NOT STARTED | [REMAINING_ENGINEERING_PLAN.md](REMAINING_ENGINEERING_PLAN.md) | — | Next in Phase 2 by the plan's own ordering, because the linter must exist before C2 and any further rewrite of large files. |

All five items dated 2026-09-20 above are carried in **PR #177** against `main`.
