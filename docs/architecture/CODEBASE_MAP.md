...
| ------------------------------------------------ | ---------------------------------------------------- | ------------------------------------------------------- | ------------------------------- | ------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `backend_app/main.py`                            | Internal backend API for secure mutations/jobs       | Request validation, auth gate, endpoint orchestration, observability logging   | Core CRUD rules                 | `backend_app.security.py`, `backend_app/jobs.py`, `src.crud` | backend API tests, security/rate-limit tests                                                                                                                                            |
