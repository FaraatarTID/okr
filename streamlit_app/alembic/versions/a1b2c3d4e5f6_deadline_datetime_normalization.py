...
def upgrade() -> None:
    ...
    try:
        op.alter_column(
            "objective", "deadline", type_=sa.DateTime(), existing_nullable=True
        )
    except Exception:
        pass
    try:
        op.alter_column(
            "key_result", "deadline", type_=sa.DateTime(), existing_nullable=True
        )
    except Exception:
        pass
    try:
...
def downgrade() -> None:
    ...
    try:
        op.alter_column(
            "key_result", "deadline", type_=sa.Integer(), existing_nullable=True
        )
    except Exception:
        pass
    try:
        op.alter_column(
            "objective", "deadline", type_=sa.Integer(), existing_nullable=True
        )
    except Exception:
        pass
    try:
