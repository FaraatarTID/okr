...
from src.models import User, Team, Goal
...
def smoke_test():
    ...
    try:
        with get_session_context() as session:
            ...
            try:
                session.exec(text("SELECT owner_id, team_id, created_by, updated_by FROM goal LIMIT 1"))
                print("Goal table has new columns (owner_id, team_id, created_by, updated_by).")
