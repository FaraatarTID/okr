...
def check_for_cycle(session: Session, proposed_parent_id: int, proposed_child_id: int) -> bool:
    """
...
def get_alignment_neighbors(session: Session, objective_id: int) -> Tuple[List[Objective], List[Objective]]:
    """
