...
def render_atlas_workspace_from_components(*, components_module, username):
    ...
    return cm.atlas_workspace_orchestrator_helpers.render_atlas_workspace(
        st_module=cm.st,
        ...
        fire_browser_notification_fn=atlas_treemap_helpers.atlas_fire_browser_notification,
