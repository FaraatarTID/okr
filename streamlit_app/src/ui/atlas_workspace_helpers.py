...
def build_ai_suggested_payload(
    *,
    ...
    return atlas_workspace_ai_helpers.build_ai_suggested_payload(
        ai_pick=ai_pick,
...
def build_ai_sync_report(
    *,
    ...
    return atlas_workspace_ai_helpers.build_ai_sync_report(
        synced=synced,
        failed=failed,
        total_kr=total_kr,
...
def build_ai_sync_sidebar_messages(
    *,
    ...
    return atlas_workspace_ai_helpers.build_ai_sync_sidebar_messages(
...
def build_ai_undo_sidebar_messages(
    *,
    ...
    return atlas_workspace_ai_helpers.build_ai_undo_sidebar_messages(
...
def apply_ai_progress_undo(
    *,
    ...
    return atlas_workspace_ai_helpers.apply_ai_progress_undo(
...
def run_ai_progress_sync(
    *,
    ...
    return atlas_workspace_ai_helpers.run_ai_progress_sync(
