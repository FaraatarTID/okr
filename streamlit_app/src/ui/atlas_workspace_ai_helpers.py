...
apply_ai_progress_undo = atlas_workspace_ai_sync_helpers.apply_ai_progress_undo
run_ai_progress_sync = atlas_workspace_ai_sync_helpers.run_ai_progress_sync
